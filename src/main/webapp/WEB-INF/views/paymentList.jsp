            ...
            <div class="table-responsive" >
                <table class="table table-striped table-hover table-light" id="paymentTable">
                    ...
                    <c:forEach items="${allPayments}" var="allPayments">
                        <tr>
                            <td>${allPayments.type}</td>
                            <td>${allPayments.amount}</td>
                            <td>${allPayments.balance}</td>
                            <td>${allPayments.payedTo}</td>
                            <td>${allPayments.payedTo}</td>
                            <td><button type="button" class="btn btn-primary btn-sm mr-3" style="border-radius:50%"><i class="fas fa-search"></i></button></td>
                        </tr>
                    </c:forEach>
                </table>
            </div>
