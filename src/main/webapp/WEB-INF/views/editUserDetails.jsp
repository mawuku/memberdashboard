    ...
    <div class="row">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
            ...
            <ol class="breadcrumb breadcrumb-md bg-white">
                ...
                <li class="breadcrumb-item active">Update Member Details</li>
            </ol>
                ...
                <div class="row">
                    ...
                    <div class="col-md-5 border-right">
                        <div class="p-3 py-5">
                            ...
                            <div class="mt-5 text-center"><a class="btn btn-danger profile-button" href="<spring:url value=''/>"> Update Member Details</a></div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="p-3 py-5">
